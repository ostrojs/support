...
const Collect = (function() {
    return class Collection extends Macroable.extend(CollectionInterface) {
        constructor(data) {
            super()
            this.$items = data;
        ...
        take(clause) {
            return lodash[((typeof clause == 'function') ? 'pickBy' : 'pick')](this.$items, clause)
        }
...
class Collection extends Macroable.extend(CollectionInterface) {
    ...
    __get(target, method) {
        return this.make(new Collect(target.$items), method)
